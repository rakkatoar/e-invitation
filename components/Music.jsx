...
const Music = () => {
  ...
  return (
        <div className="">
					<div className="bg-cultured fixed bottom-5 left-5 rounded-full border-2 p-3">
					...
					<div className="hidden">
						...
						<YouTube videoId="1ieSEOX5OEE" opts={opts} onReady={_onReady} onPlay={setPlay} onPause={setPause}  />
					</div>
        </div>
    );
};
