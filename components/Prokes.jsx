...
const Prokes = () => {
    ...
    return (
        <div className="lg:px-[10vw] lg:py-[5vw] p-5 bg-cultured">
					...
					<p className="text-center">Mari saling menjaga kesehatan dengan mengikuti protokol kesehatan sesuai anjuran pemerintah untuk mengurangi penyebaran Covid-19</p>
        </div>
    );
};
